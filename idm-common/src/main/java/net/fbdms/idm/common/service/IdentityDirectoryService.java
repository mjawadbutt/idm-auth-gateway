...
public interface IdentityDirectoryService {
   ...
   * @throws net.fbdms.idm.common.exception.AuthenticationException if credentials
   *                                                                are invalid
   */
  @NotNull
   ...
   * @throws net.fbdms.idm.common.exception.TenantResolutionException if the user
   *                                                                  is not a
   *                                                                  member of
   *                                                                  the tenant
   */
